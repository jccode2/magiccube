<!--
   ...
   4. Fine tune the looks with CSS. Details: http://moot.it/docs/?1000funs#styling

   For more help:

   http://moot.it/docs/?1000funs
   http://moot.it/forum/
-->
<!doctype html>
...
<!--       <a class="moot" href="http://api.moot.it/1000funs"></a> -->

      
<!--          (2) Example tag for commenting, put it on a different page -->
<!--          <a class="moot" href="http://api.moot.it/1000funs/blog#my-blog-entry"></a> -->

<!--          (2) Example tag for threaded commenting -->
         <a class="moot" href="http://api.moot.it/1000funs/blog/my-large-blog-entry"></a>

<!--          Moot paths are awesome: http://moot.it/docs/?1000funs#path -->
