...
public class FoodDAO extends BaseDAO {
	...
	public int queryIdForFoodVO(FoodVO foodVO) {
		return (Integer)this.sqlSessionTemplate.selectOne("com.magiccube.food.queryIdForFoodVO", foodVO);
	}
	...
	public int insertFoodReShop(FoodVO foodVO){
		return (Integer)this.sqlSessionTemplate.insert("com.magiccube.food.insertFoodReShop", foodVO);
	}
	
	public int insertPackageItem(PackageItemVO packageItemVO) {
		this.sqlSessionTemplate.insert("com.magiccube.food.insertPackageItem", packageItemVO);
	...
	public int insertFoodGroup(FoodGroupVO foodGroupVO){
		this.sqlSessionTemplate.insert("com.magiccube.food.insertFoodGroup",foodGroupVO);
	...
	public int updateGroup(FoodGroupVO foodGroupVO) {
		return this.sqlSessionTemplate.update("com.magiccube.food.updateGroup", foodGroupVO);
	}
	...
	public int deleteFood(int id) {
		return this.sqlSessionTemplate.update("com.magiccube.food.deleteFood", id);
	}
	...
	public int deleteFoodReShop(int foodId) {
		...
		foodVO.setId(foodId);
		foodVO.setShopId(shopId);
		return this.sqlSessionTemplate.delete("com.magiccube.food.deleteFoodReShop", foodVO);
	}
	...
	public int deletePackageItem(int packageId) {
		return this.sqlSessionTemplate.delete("com.magiccube.food.deletePackageItem", packageId);
	}
	
	public List<FoodVO> queryFoodsByShopId(int shopId){
		List<FoodVO> result =  this.sqlSessionTemplate.selectList("com.magiccube.food.queryFoodsByShopId", shopId);
		return result;
	}
	
	public int queryCountOfFood(){
		return (Integer)this.sqlSessionTemplate.selectOne("com.magiccube.food.queryCountOfFood");
	}
	...
	public List<GroupFoods> queryAllGroupAndFoods(FoodQueryCondition foodQueryCondition) {
		List<FoodVO> foods = this.sqlSessionTemplate.selectList("com.magiccube.food.queryAllGroupAndFoods", foodQueryCondition);
	...
	public List<GroupFoods> queryAvailableGroupAndFoods(FoodQueryCondition foodQueryCondition) {
		List<FoodVO> foods = this.sqlSessionTemplate.selectList("com.magiccube.food.queryAvailableGroupAndFoods", foodQueryCondition);
		return transferFoodVOToGroupFoods(foods);
	}
	...
	public List<FoodGroupVO> queryGroups(int type) {
		List<FoodGroupVO> result = this.sqlSessionTemplate.selectList("com.magiccube.food.queryGroups", type);
		return result;
	}
	
	public List<FoodGroupVO> queryAllGroups() {
		List<FoodGroupVO> result = this.sqlSessionTemplate.selectList("com.magiccube.food.queryAllGroups");
		return result;
	}
	...
	public List<FoodVO> querySingleFoods(FoodQueryCondition queryCondition) {
		List<FoodVO> foods = this.sqlSessionTemplate.selectList("com.magiccube.food.querySingleFoods", queryCondition);
		return foods;
	}
	...
	public List<FoodVO> queryAvailableFoods(FoodQueryCondition queryCondition) {
		List<FoodVO> foods = this.sqlSessionTemplate.selectList("com.magiccube.food.queryAvailableFoods", queryCondition);
		return foods;
	}
